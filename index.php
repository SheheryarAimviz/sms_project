       ...
       <div class="row">
             ...
             <div class="card p-30">
                <div class="media">
                   <div class="media-left meida media-middle">
                      <span><i class="fa icon-student f-s-60 color-primary"></i></span>
                   </div>
          ...
          <div class="col-md-3">
             <div class="card p-30">
                <div class="media">
                   <div class="media-left meida media-middle">
                      <span><i class="fa fa-user f-s-60 color-success"></i></span>
                   </div>
                   <div class="media-body media-text-right">
                      <h2>20</h2>
                      <p class="m-b-0">Total Parents</p>
                   </div>
                </div>
             </div>
          </div>
          <div class="col-md-3">
             <div class="card p-30">
                <div class="media">
                   <div class="media-left meida media-middle">
                      <span><i class="fa icon-teacher f-s-60 color-warning"></i></span>
                   </div>
                   <div class="media-body media-text-right">
                      <h2>25</h2>
                      <p class="m-b-0">Total Teacher</p>
                   </div>
                </div>
             </div>
          </div>
          <div class="col-md-3">
             <div class="card p-30">
                <div class="media">
                   <div class="media-left meida media-middle">
                      <span><i class="fa icon-subject f-s-60 color-danger"></i></span>
                   </div>
                   <div class="media-body media-text-right">
                      <h2>40</h2>
                   ...
                   <div class="testimonial-widget-one owl-carousel owl-theme">
                      <div class="item">
                         <div class="testimonial-content">
                            <img class="testimonial-author-img" src="images/users/2.jpg" alt="" />
                      ...
                      <div class="item">
                         <div class="testimonial-content">
                            <img class="testimonial-author-img" src="images/users/3.jpg" alt="" />
                      ...
                      <div class="item">
                         <div class="testimonial-content">
                            <img class="testimonial-author-img" src="images/users/1.jpg" alt="" />
                      ...
                      <div class="item">
                         <div class="testimonial-content">
                            <img class="testimonial-author-img" src="images/users/4.jpg" alt="" />
                      ...
                      <div class="item">
                         <div class="testimonial-content">
                            <img class="testimonial-author-img" src="images/users/5.jpg" alt="" />
                            <div class="testimonial-author">TYRION LANNISTER</div>
                            <div class="testimonial-author-position">Founder-Ceo. Dell Corp</div>
                            <div class="testimonial-text">
                               <i class="fa fa-quote-left"></i>  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation .
                      ...
                      <div class="item">
                         <div class="testimonial-content">
                            <img class="testimonial-author-img" src="images/users/6.jpg" alt="" />
                            <div class="testimonial-author">TYRION LANNISTER</div>
                            <div class="testimonial-author-position">Founder-Ceo. Dell Corp</div>
                            <div class="testimonial-text">
                               <i class="fa fa-quote-left"></i>  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation .
                      ...
                      <table class="table">
                         ...
                         <tbody>
                            ...
                            <tr>
                               <td>
                                  <div class="round-img">
                                     <a href=""><img src="images/users/2.jpg" alt=""></a>
                                  </div>
                               </td>
                               <td>John Abraham</td>
                            ...
                            <tr>
                               <td>
                                  <div class="round-img">
                                     <a href=""><img src="images/users/3.jpg" alt=""></a>
                                  </div>
                               </td>
                               <td>John Abraham</td>
                      ...
                      <div class="recent-comment">
                         <div class="media">
                            <div class="media-left">
                               <a href="#"><img alt="..." src="images/users/1.jpg" class="media-object"></a>
                            </div>
