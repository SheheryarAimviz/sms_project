    ...
    <div class="row page-titles">
       <div class="col-md-5 align-self-center">
          <h3 class="text-primary">
            <i class="fa icon-teacher"></i>&nbsp; Teacher
          </h3>
       </div>
               ...
               <div class="row">
                 <div class="col-md-4">
                   <h4 class="card-title eduinsto-card-title">
                     <a href="teacher_add.php"> <i class="fa fa-plus"></i>&nbsp; Add a teacher</a>
                   </h4>
                 </div>
               </div>
                     ...
                     <tbody>
                       <tr>
                         ...
                         <td data-title="Action">
                           <a href="teacher_view.php" class="btn btn-success btn-xs mrg" data-placement="top" data-toggle="tooltip" data-original-title="View">
