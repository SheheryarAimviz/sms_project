   ...
   <div class="scroll-sidebar">
      ...
      <nav class="sidebar-nav">
         <ul id="sidebarnav">
            ...
            <li>
              <a href="parents.php" aria-expanded="false">
                <i class="fa fa-user"></i>
                <span class="hide-menu">Parents</span>
              </a>
            </li>
            <li>
              <a href="teacher.php" aria-expanded="false">
            ...
            <li>
               <a class="has-arrow" href="#" aria-expanded="false">
                 ...
                 <span class="hide-menu">Mark</span>
               </a>
               <ul aria-expanded="false" class="collapse">
                  <li>
                   <a href="mark.php" aria-expanded="false">
                     <i class="fa fa-flask"></i>
                     <span>&nbsp;Mark</span>
                   </a>
                  </li>
                  <li>
                   <a href="mark_percentage.php" aria-expanded="false">
            ...
            <!-- Message -->
            <li>
              <a href="user.html" aria-expanded="false">
                <i class="fa fa-envelope"></i>
