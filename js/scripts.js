$(function() {
    ...
    $(window).ready(i), $(window).on("resize", i), $(".sidebartoggler").on("click", function() {
        ...
        $('.photo').on('change', function() {
          if ($(this).val() != "") {
            $(this).closest('.row').find('.image-preview-clear').removeClass('hidden');
          }
          else {
            $(this).closest('.row').find('.image-preview-clear').addClass('hidden');
          }
          $(this).closest('.row').find('.image-preview-filename').val($(this).val());
        });

        $('.image-preview-clear').on('click', function() {
          $(this).closest('.row').find('.image-preview-input').children('.photo').val('');
          $(this).closest('.row').find('.image-preview-filename').val('');
